...
<head>
  ...
  <link href="{{asset('argon/assets/css/nucleo-svg.css" rel="stylesheet')}}" />
  <!-- CSS Files -->
  <link href="{{asset('argon/assets/css/argon-design-system.css?v=1.2.0')}}" rel="stylesheet" />
</head>
...
<body class="index-page">
  ...
  <div class="section" style="background-image: url('argon/assets/img/ill/1.svg');">
        ...
        <div class="col-md-6 mb-5 mb-md-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="./examples/landing.html" title="Landing Page">
              <img src="{{asset('argon/assets/img/theme/landing.jpg')}}" class="card-img">
            </a>
          </div>
        </div>
        <div class="col-md-6 mb-5 mb-lg-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="./examples/profile.html" title="Profile Page">
              <img src="{{asset('argon/assets/img/theme/profile.jpg')}}" class="card-img">
            </a>
          </div>
        </div>
      </div>
  ...
  <script src="{{asset('argon/assets/js/core/bootstrap.min.js" type="text/javascript')}}"></script>
  ...
  <script src="{{asset('argon/assets/js/argon-design-system.min.js?v=1.2.0')}}" type="text/javascript"></script>
  <script>
